...
function Pedidos_fechados() {
    ...
    if (data.value.length < 10) {
        ...
        var dataTratada = moment(data.value, "DD/MM/YYYY");
        ...
        $.ajax({
            type: 'GET',
            url: url + '/pedidos_empresa/-1/100/' + dataTratada,
            headers: {
                "token": token,
            },
            ...
            success: function (data) {
                ...
                for (var a = 0; a< data.length; a++) { //enquanto nao terminar de ter resultados ele continua salvando nos vetores
                    var html = "";
                    ...
                    if (status_pedido === 6) { //se ele  foi rejeitado preciso mostrar q foi rejeitado !
                        contador++;
                        html += "<div id = pedido" + id + "  class = 'container flex'  style= 'border : 5px solid black' > ";
                        html += "<div class='item flex-item-1' id='titulo'><h1 id='titulopedido" + id + "' style='color : black'>Pedido " + id + "<span id='rejeitado'>  REJEITADO! </span>";

                        html += "</h1></div><div class='item flex-item-1' id='pedido'><h2>Pedido</h2><div  class= 'itensagrupados' id='agruparqtditens" + id + "'>";
                        ...
                        html += "</div><section class='content flex' style='border-top:2px solid black' id='ordem" + id + "'><div id='valor' class='item flex-item-1'><p class='preco' id='preco" + id + "'>R$" + preco;
                        if (cartao == 0) { //nao é cartao
                       ...
                       // html += "<h2>Motoqueiro</h2><p id='nome_motoqueiro" + id + "'>" + motoqueiro_nome + "</p>";
                        html += "</div></div>";
                    } else if (status_pedido == 5) { // apenas fechados
                        contador++;
                        html += "<div id = pedido" + id + "  class = 'container flex'  style= 'border : 5px solid black' > ";
                        html += "<div class='item flex-item-1' id='titulo'><h1 id='titulopedido" + id + "' style='color : black'>Pedido " + id;
