...
<head>
    ...
    <script src="_javascript/editar_horario.js"></script>
            ...
            <div id="formulario" class="container flex">
                ...
                <div id="parte1" class="item flex-item-1">
                    ...
                    <div class="was-validated">
                        <div class="custom-control custom-checkbox mb-4" id="dia_7" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="domingoValidation" onclick="checkbox()" required>
                            ...
                            <div class="valid-feedback">
                                ...
                                <input type="text" id="domingoID" style="display: none">
                            </div>
                        </div> 
                        <div class="custom-control custom-checkbox mb-4" id="dia_1" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="segundaValidation" onclick="checkbox()" required>
                            ...
                            <div class="valid-feedback">
                                ...
                                <input type="text" id="segundaID" style="display: none">

                            </div>
                        </div> 
                        <div class="custom-control custom-checkbox mb-4" id="dia_2" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="tercaValidation" onclick="checkbox()" required >
                           ...
                           <div class="valid-feedback">
                                ...
                                <input type="text" id="tercaID" style="display: none">
                            </div>
                        </div>
                         <div class="custom-control custom-checkbox mb-4" id="dia_3" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="quartaValidation" onclick="checkbox()" required>
                            ...
                            <div class="valid-feedback">
                                ...
                                <input type="text" id="quartaID" style="display: none">    
                            </div>
                        </div>
                         <div class="custom-control custom-checkbox mb-4" id="dia_4" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="quintaValidation" onclick="checkbox()" required >
                            ...
                            <div class="valid-feedback">
                                ...
                                <input type="text" id="quintaID" style="display: none">
                            </div>
                        </div>
                         <div class="custom-control custom-checkbox mb-4" id="dia_5" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="sextaValidation" onclick="checkbox()" required >
                            ...
                            <div class="valid-feedback">
                                ...
                                <input type="text" id="sextaID" style="display: none">
                            </div>
                        </div>
                        <div class="custom-control custom-checkbox mb-4" id="dia_6" style="display: none">
                            <input type="checkbox" class="custom-control-input" id="sabadoValidation" onclick="checkbox()" required >
                            ...
                            <div class="valid-feedback">
                                ...
                                <input type="text" id="sabadoID" style="display: none">
                            </div>
                        </div>
                            
                        <div id="fim">
                            <button id="enviar" type="submit" class="btn btn-primary" onclick="editarHorario()">Confirmar
                            </button>
                        </div>
                    </div>
                </div>
  ...
  $footer
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#domingoA").mask('00:00:00'); 
            $("#domingoF").mask('00:00:00'); 
            $("#segundaA").mask('00:00:00'); 
            $("#segundaF").mask('00:00:00'); 
            $("#tercaA").mask('00:00:00'); 
            $("#tercaF").mask('00:00:00'); 
            $("#quartaA").mask('00:00:00'); 
            $("#quartaF").mask('00:00:00'); 
            $("#quintaA").mask('00:00:00'); 
            $("#quintaF").mask('00:00:00'); 
            $("#sextaA").mask('00:00:00'); 
            $("#sextaF").mask('00:00:00'); 
            $("#sabadoA").mask('00:00:00'); 
            $("#sabadoF").mask('00:00:00'); 
